...
AVTransport.prototype.AddURIToSavedQueue = async function (options) { return this._request('AddURIToSavedQueue', options) }
...
AVTransport.prototype.ReorderTracksInSavedQueue = async function (options) { return this._request('ReorderTracksInSavedQueue', options) }
/**
...
AVTransport.prototype.CreateSavedQueue = async function (title) { return this._request('CreateSavedQueue', { InstanceID: 0, Title: title, EnqueuedURI: '', EnqueuedURIMetaData: '' }) }
...
AVTransport.prototype.GetPositionInfo = async function () {
