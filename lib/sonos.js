...
/**
 * Get device balance as number from -100 (full right) to +100 (full left), where 0 is left and right equal
 * @returns {Promise}
 */
...
/**
 * Set device balance
 * @param {Number} balance  from -100 (full right) to +100 (full left), where 0 is left and right equal
 * @returns {Promise}
 */
