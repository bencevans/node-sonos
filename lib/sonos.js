...
Sonos.prototype.setPlayMode = function(playmode, callback) {
  ...
  var body = '<u:SetPlayMode xmlns:u="urn:schemas-upnp-org:service:AVTransport:1"><InstanceID>0</InstanceID><NewPlayMode>' + mode + '</NewPlayMode></u:SetPlayMode>';
...
Sonos.prototype.setMuted = function(muted, callback) {
  ...
  var body = '<u:SetMute xmlns:u="urn:schemas-upnp-org:service:RenderingControl:1"><InstanceID>0</InstanceID><Channel>Master</Channel><DesiredMute>' + (parseInt(muted, 10) ? '1' : '0') + '</DesiredMute></u:SetMute>';
