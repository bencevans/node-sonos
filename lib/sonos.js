 ...
 */
var Search = function Search(timeout) {
  ...
  if (timeout) {
    setTimeout(function() { _this.socket.close(); }, timeout);
  }
 ...
 * @param  {int} Optional timeout value in milliseconds.
 * @return {Search/EventEmitter Instance}
 */
var search = function(listener, timeout) {
  var search = new Search(timeout);
