...
var optionsFromTuneinUri = function (uri, title) {
  var meta = '<DIDL-Lite xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:upnp="urn:schemas-upnp-org:metadata-1-0/upnp/" xmlns:r="urn:schemas-rinconnetworks-com:metadata-1-0/" xmlns="urn:schemas-upnp-org:metadata-1-0/DIDL-Lite/"><item id="F00092020s##TUNEINSTATIONID##" parentID="L" restricted="true"><dc:title>##TUNEINSTATIONTITLE##</dc:title><upnp:class>##TUNEINTYPE##</upnp:class><desc id="cdudn" nameSpace="urn:schemas-rinconnetworks-com:metadata-1-0/">SA_RINCON65031_</desc></item></DIDL-Lite>'
  return {
    uri,
    metadata: meta.replace('##TUNEINSTATIONID##', uri).replace('##TUNEINSTATIONTITLE##', title).replace('##TUNEINTYPE##', 'object.item.audioItem.audioBroadcast')
  }
}
...
Sonos.prototype.playTuneinRadio = function (stationId, stationTitle, callback) {
  ...
  //var options = optionsFromTuneinUri(stationId, stationTitle)
