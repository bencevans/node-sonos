 ...
 * @param  {String}   uri             URI to Audio Stream
 * @param  {Number}   positionInQueue Position in queue at which to add song (1-indexed, 0 means end of queue)
 * @param  {Function} callback (err, queued)
 */
Sonos.prototype.addToQueue = function(uri, positionInQueue, callback) {
  debug('Sonos.addToQueue(%j, %j, %j)', uri, positionInQueue, callback);
