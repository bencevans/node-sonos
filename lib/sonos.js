...
var serviceListeners = [
  require('./events/volumeListener')
];

/**
 * Start service event listeners
 * @param {Function} callback {err, results}
 */
Sonos.prototype.initialize = function(callback) {
  ...
  this.listener.listen(function(err) {
    if (err) callback(err);
      ...
      async.parallel(serviceListeners.map(function(listenerInit) {
        return function(callback) {
          listenerInit(this.listener, callback);
        }.bind(this);
      }.bind(this)), callback);
...
/**
 * Stop service event listeners
 * @param {Function} callback {err, results}
 */
Sonos.prototype.destroy = function(callback) {
  this.listener.removeAllHandlers(callback);
};
...
module.exports.LogicalDevice = require('./logicalDevice');
