 ...
 * @param {import("../sonos").Sonos} device Pass in the sonos device
 */
  constructor (device) {
    this.subscriptions = []
    this.device = device
  ...
  /**
   * Cancel all the subscriptions for this device. Important to stop the notifications from returning.
   */
   ...
   * @param {string | number} timeout TimeOut header
   * @returns {number}
   */
