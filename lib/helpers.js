 ...
 */
  static GenerateCustomMetadata (streamUrl, itemId, duration = '00:00:00', title, artist, album, coverUrl, parentId) {
 ...
 */
  static GenerateLocalMetadata (uri, artUri = '') {
    let title = ''
 ...
 */
  static GenerateMetadata (uri, title = '', region = '3079') {
 ...
 * @return {object}
 */
  static ParseDIDL (didl, host = undefined, port = undefined, trackUri = undefined) {
 ...
 */
   ...
   * @returns {Object}
   */
  static _ParseXml (input, callback) {
 ...
 * @return {string}
 */
  static SanitizeDeviceDescriptionXml (input) {
